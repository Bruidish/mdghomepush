...
{if $elements && !$displayFullscreen}
  <div id="mdghomepush-slides-wrap" class="mdghomepush-slides-wrap-container splide">
    <div class="splide__track">
      <ul class="splide__list">
        {foreach $elements as $element}
          {include "module:mdghomepush/views/templates/hook/v17/_partials/slide.tpl" fullscreen=false}
        {/foreach}
      </ul>
    </div>

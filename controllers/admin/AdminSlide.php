...
use mdg\homepush\Forms\SlideForm;
use mdg\homepush\Models\SlideModel;

require_once __DIR__ . '../../../vendor/autoload.php';

class AdminSlideController extends ModuleAdminController
{
    /** @var boolean */
    public $lang = true;
    ...
    {
        $this->table = SlideModel::$definition['table'];
        $this->identifier = SlideModel::$definition['primary'];
        $this->className = SlideModel::class;
    ...
    {
        foreach ((new SlideForm($this->object))->modifyControllerFormHelper() as $key => $value) {
            $this->$key = $value;
        }

...
class PushForm extends \mdg\homepush\Forms\ObjectForm
{
    /**
     * @inheritdoc
     */
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'desc' => sprintf($this->module->l('Use size %s x %spx.', $this->form_name), $imagesNames['image_hover']['width'] ? $imagesNames['image_hover']['width'] : 'auto', $imagesNames['image_hover']['height'] ? $imagesNames['image_hover']['height'] : 'auto'),
                    ],
                ],
            ],
        ];
